...
export default function NewBlogPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const response = await fetch('/backend/api/blogs.php', {
                method: 'POST',
        ...
        <div className="min-h-screen bg-[#F8F9FA] font-sans pb-20">
            ...
            <header className="bg-dark text-white p-6 sticky top-0 z-50 flex items-center justify-between shadow-2xl">
                <div className="flex items-center gap-6">
                    ...
                    <h1 className="text-xl font-bold tracking-tight">Nouvel Article Blog</h1>
                </div>
                        ...
                        {status === 'success' && (
                            <div className="bg-green-500 rounded-[32px] p-8 text-white flex items-center gap-4 animate-fade-in">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm opacity-90 font-medium tracking-tight">Article publié avec succès sur le Hub.</p>
                                </div>
                            </div>
                        )}
